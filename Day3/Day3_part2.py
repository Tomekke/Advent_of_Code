...
def check_if_crossing(arrayA, arrayB):
    ...
    steps_of_arrayA.pop(0)
    steps_of_arrayB.pop(0)
    number_of_stepsA = len(steps_of_arrayA)
    number_of_stepsB = len(steps_of_arrayB)
    if len(steps_of_arrayA) >= len(steps_of_arrayB):
        for step in steps_of_arrayA:
            if step in steps_of_arrayB:
                if steps_of_arrayA.index(step) < number_of_stepsA:
                    number_of_stepsA = steps_of_arrayA.index(step)
                if steps_of_arrayB.index(step) < number_of_stepsB:
                    number_of_stepsB = steps_of_arrayB.index(step)
    else:
